...
class StockUtil(object):
    ...
    def prices_preds(self, start_year=2014, end_year=2016, start_month=1, period=12):
        ...
        for i in range(len(self.stocks)):
            ...
            s_prices = Stocks.interval_of_years(cod, start_year, end_year, start_month, period=period)
